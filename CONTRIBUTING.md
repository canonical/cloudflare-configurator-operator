...
This document explains the processes and practices recommended for contributing enhancements to the Cloudflare configurator Operator.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/cloudflare-configurator-operator/issues) explaining your use case.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/cloudflare-configurator-operator)
...
Canonical welcomes contributions to the Cloudflare configurator Operator. Please check out our
...
```
git clone https://github.com/canonical/cloudflare-configurator-operator
```
...
OCI image for the Cloudflare configurator app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./cloudflare-configurator*.charm 
```
